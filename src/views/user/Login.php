<?php 
    ...
    $reg = LinkParser::getLink("register");
    $regImg = LinkParser::getLink("logImg");
    $regBack = LinkParser::getLink("logBack");
    ...
    $res = DBManager::validateUser($fullname,$password);
            ...
            <div class="row justify-content-center">
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <form class="mx-1 mx-md-4" name="form" method="post" action="">
                  ...
                  <p>Do not have an account? <a href="<?php echo $reg?>">Sign up here</a>.</p>
